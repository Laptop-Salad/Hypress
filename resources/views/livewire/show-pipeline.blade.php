                ...
                <div class="space-y-4">
                    <x-card>
                        ...
                        <div class="p-5 flex items-center space-x-2">
                            <i class="{{$this->pipeline->health->icon()}} fa-2xl me-2"></i>

                            <p class="text-lg font-semibold">{{$this->pipeline->health->display()}}</p>
                        </div>
                    </x-card>
                    ...
                    <x-card>
                        ...
                        <div>
                            @forelse($this->pipeline->alerts as $alert)
                        ...
                        <div class="md:flex justify-center text-sm">
                            ...
                            <div class="md:border-e md:border-b-0 border-b py-2 px-4">
                                ...
                                <p>
                                    ...
                                    {{$this->pipeline->open_anomaly_count}}
                                </p>
                            </div>
                ...
                <div class="md:px-5 md:my-0 my-2">
                    <x-card>
                        ...
                        <div class="md:grid grid-cols-2 p-2 md:space-y-0 space-y-2">
                            ...
                            <p class="md:px-2 font-semibold md:border-b-0 border-b md:pb-0 pb-2">{{$this->pipeline->last_inspection->format('d-m-Y')}}</p>
                        </div>
                        <div class="md:grid grid-cols-2 p-2 md:space-y-0 space-y-2">
                            <p class="border-e">Next Date of Maintenance</p>
                            <p class="md:px-2 font-semibold">{{$this->pipeline->next_maintenance->format('d-m-Y')}}</p>
                        </div>
                    </x-card>
                </div>
            </div>
